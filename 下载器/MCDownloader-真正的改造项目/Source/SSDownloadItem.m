...
//自定义文件的存储路径
- (void)setCustomFilePathBlock:(nullable SSDownloaderManagerReceiptCustomFilePathBlock)customFilePathBlock {
...
- (instancetype)initWithURLString:(NSString *)URLString
     downloadOperationCancelToken:(id)downloadOperationCancelToken
          downloaderProgressBlock:(SSDownloaderManagerProgressBlock)downloaderProgressBlock
         downloaderCompletedBlock:(SSDownloaderManagerCompletedBlock)downloaderCompletedBlock {
...
- (void)setDownloaderProgressBlock:(SSDownloaderManagerProgressBlock)downloaderProgressBlock {
    _downloaderProgressBlock = downloaderProgressBlock;
}

- (void)setDownloaderCompletedBlock:(SSDownloaderManagerCompletedBlock)downloaderCompletedBlock {
